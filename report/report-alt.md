...
| SINDy-RL Polynomial | 116,277$^\dagger$ | — | 85% | 84 terms |
...
The distilled polynomial is **116× smaller** than the baseline network and evaluates as a single dot product, compatible with microcontroller deployment and amenable to analytical stability arguments that a neural network cannot support.
